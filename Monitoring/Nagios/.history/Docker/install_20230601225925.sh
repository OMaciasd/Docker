...
sudo echo alias nagioscheck='/usr/local/nagios/bin/nagios -v /usr/local/nagios/etc/nagios.cfg' >> /root/.bashrc
sudo echo alias nagiosreload='systemctl restart nagios' >> /root/.bashrc

sudo service startnagios
        sudo serviceenable nagios
        echo q | sudo servicestatus nagios

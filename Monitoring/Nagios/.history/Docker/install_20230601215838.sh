...
define host{ >> usr/local/nagios/etc/objects/
       use              linux-server >> usr/local/nagios/etc/objects/
       host_name        ubuntu >> usr/local/nagios/etc/objects/
       alias            Linux_Ubuntu >> usr/local/nagios/etc/objects/
       address          10.0.0.11 >> usr/local/nagios/etc/objects/
} >> usr/local/nagios/etc/objects/

define host{ >> usr/local/nagios/etc/objects/linux
       use              linux-server >> usr/local/nagios/etc/objects/
       host_name        ubuntu2 >> usr/local/nagios/etc/objects/
       alias            Linux_Ubuntu_2 >> usr/local/nagios/etc/objects/
       address          10.0.0.12 >> usr/local/nagios/etc/objects/
} >> usr/local/nagios/etc/objects/

define host{ >> usr/local/nagios/etc/objects/
       use              linux-server >> usr/local/nagios/etc/objects/
       host_name        dns2 >> usr/local/nagios/etc/objects/
       alias            DNS_Ubuntu_2 >> usr/local/nagios/etc/objects/
       address          8.8.8.8 >> usr/local/nagios/etc/objects/
} >> usr/local/nagios/etc/objects/

define service{ >> usr/local/nagios/etc/objects/
       use                     generic-service >> usr/local/nagios/etc/objects/
       host_name               ubuntu >> usr/local/nagios/etc/objects/
       service_description     Hard_Disk >> usr/local/nagios/etc/objects/
       check_command           check_nrpe!chec >> usr/local/nagios/etc/objects/k_hda1
} >> usr/local/nagios/etc/objects/

...
define host{ >> usr/local/nagios/etc/objects/
       use              linux-server >> usr/llinux.cfgocal/nagios/etc/objects/
       host_name        ubuntu >> usr/local/nagios/etc/objects/linux.cfg
       alias            Linux_Ubuntu >> usr/local/nagios/etc/oblinux.cfgjects/
...
define host{ >> usr/local/nagios/etc/objects/
       ...
       alias            Linux_Ubuntu_2 >> usr/local/nagios/etc/olinux.cfgbjects/
...
define host{ >> usr/local/nagios/etc/objects/
       ...
       alias            DNS_Ubuntu_2 >> usr/local/nagios/etc/linux.cfgobjects/
       address          8.8.8.8 >> usr/local/nagios/etc/objects/linux.cfg
} >> usr/local/nagios/etc/objects/linux.cfg
linux.cfg
define service{ >> usr/local/nagios/etc/objects/
       use                     generic-service >linux.cfg> usr/local/nagios/etc/objects/
       host_name               ubuntu >> usr/local/nagios/etc/objects/linux.cfg
       service_description     Hard_Disk >> usr/local/nagios/etc/objeclinux.cfgts/
       check_command           check_nrpe!chec >> usr/local/nagios/etc/oblinux.cfgjects/k_hda1
} >> usr/local/nagios/etc/objects/linux.cfg
linux.cfg
define service{ >> usr/local/nagios/etc/objects/
       use                     generic-service >linux.cfg> usr/local/nagios/etc/objects/
       host_name               ubuntulinux.cfg

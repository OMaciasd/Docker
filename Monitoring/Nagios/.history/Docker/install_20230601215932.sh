...
# Host Services.
define host{ >> usr/local/nagios/etc/objects/
       use              linux-server >> usr/llinux.cfgtc/objects/
       host_name        ubuntu >> usr/local/nagios/etc/objects/linux.cfg            Linux_Ubuntu >> usr/local/nagios/etc/oblinux.cfg address          10.0.0.11 >> usr/local/nagios/etc/objects/linux.cfgal/nagios/etc/objects/linux.cfg >> usr/local/nagios/etc/objects/
       use              linux-server >> usr/llinux.cfgtc/objects/
       host_name        ubuntu2 >> usr/local/nagios/etc/objects/linux.cfg            Linux_Ubuntu_2 >> usr/local/nagios/etc/olinux.cfg  address          10.0.0.12 >> usr/local/nagios/etc/objects/linux.cfgal/nagios/etc/objects/linux.cfg >> usr/local/nagios/etc/objects/
       use              linux-server >> usr/llinux.cfgtc/objects/
       host_name        dns2 >> usr/local/nagios/etc/objects/linux.cfg            DNS_Ubuntu_2 >> usr/local/nagios/etc/linux.cfg   address          8.8.8.8 >> usr/local/nagios/etc/objects/linux.cfgal/nagios/etc/objects/linux.cfgce{ >> usr/local/nagios/etc/objects/
       use                     generic-service >linux.cfgagios/etc/objects/
       host_name               ubuntu >> usr/local/nagios/etc/objects/linux.cfgce_description     Hard_Disk >> usr/local/nagios/etc/objeclinux.cfgeck_command           check_nrpe!chec >> usr/local/nagios/etc/oblinux.cfg} >> usr/local/nagios/etc/objects/linux.cfgce{ >> usr/local/nagios/etc/objects/
       use                     generic-service >linux.cfgagios/etc/objects/
       host_name               ubuntulinux.cfgce_description     Ping

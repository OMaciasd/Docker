...
define command{ >> /usr/local/nagios/etc/objects/commands.cfg
    command_name check_nrpe >> /usr/local/nagios/etc/objects/commands.cfg
    command_line $USER1$/check_nrpe -H $HOSTADDRESS$ -c $ARG1$ >> /usr/local/nagios/etc/objects/commands.cfg
} >> /usr/local/nagios/etc/objects/commands.cfg

define command { >> /usr/local/nagios/etc/objects/commands.cfg >> /usr/local/nagios/etc/objects/commands.cfg
    command_name    check_traceroute >> /usr/local/nagios/etc/objects/commands.cfg
    command_line    /usr/sbin/traceroute -n -T -p $ARG2$ $HOSTADDRESS$ >> /usr/local/nagios/etc/objects/commands.cfg
}
